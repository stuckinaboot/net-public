 ...
 */
const MAX_BATCH_SIZE_BYTES = 900 * 1024; // 900KB
 ...
 */
const MAX_TRANSACTION_SIZE_BYTES = 100 * 1024; // 100KB
 ...
 */
function estimateTransactionSize(tx: WriteTransactionConfig): number {
