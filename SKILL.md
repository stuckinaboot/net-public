...
| **Save Character** | Save a reusable persona (JSON) on-chain that AIs/Bankr can adopt as a role | `netp storage upload --file character-ada.json --key "character-ada" --text "Ada" --chain-id 8453` | [characters.md](https://raw.githubusercontent.com/stuckinaboot/net-public/main/skill-references/characters.md) |
| **Load Character** | Load a shared character by operator + key and adopt its persona | `netp storage read --key "character-ada" --operator 0xAddr --chain-id 8453 --json --raw` | [characters.md](https://raw.githubusercontent.com/stuckinaboot/net-public/main/skill-references/characters.md) |
